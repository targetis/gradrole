<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="jh-navbar">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">gradrole</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/student">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.student')">Student</span>
          </b-dropdown-item>
          <b-dropdown-item to="/user-ext">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.userExt')">User Ext</span>
          </b-dropdown-item>
          <b-dropdown-item to="/student">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.student')">Student</span>
