...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().name(DEFAULT_NAME).email(DEFAULT_EMAIL).dob(DEFAULT_DOB).course(DEFAULT_COURSE);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().name(UPDATED_NAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).course(UPDATED_COURSE);
        return student;
    }
    ...
    void updateStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).course(UPDATED_COURSE);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).email(UPDATED_EMAIL).dob(UPDATED_DOB).course(UPDATED_COURSE);
